...
.stButton>button { width: 100%; border-radius: 12px; background-color: #007AFF; color: white; font-weight: 600; border: none; height: 3.5em; }
</style>
...
# 5. 조별 명단 (들여쓰기 오류 방지를 위해 텍스트로 처리)
st.divider()
