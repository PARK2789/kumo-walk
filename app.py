...
<style>
    ...
    .hero-section {{
        ...
        padding: 250px 25px 35px 25px; border-radius: 0 0 35px 35px;
...
if st.session_state.view == 'home':
    st.markdown(f"""
    <div class="hero-section"><div class="hero-title">CEO Talk⁺</div><div style="font-size: 17px; opacity: 0.9; margin-top: 8px;">함께 걷는 금오산 올레길</div></div>
    """, unsafe_allow_html=True)
    ...
    <div class="info-box">
        ...
        <div style="font-size:15px; color:#3A3A3C; font-weight:600; margin-top:4px;">출발 시간: <b>15:30까지 집결</b></div>
